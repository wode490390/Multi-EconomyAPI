...
public class GiveMoneyCommand extends Command {
    ...
    public GiveMoneyCommand(MultiEconomyAPI plugin) {
        super("mgivemoney", "Gives money to player", "/givemoney <player> <amount>");
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if (!sender.hasPermission("multieconomyapi.command.givemoney")) {
