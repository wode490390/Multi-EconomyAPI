...
public class SetMoneyCommand extends Command {
    ...
    public SetMoneyCommand(MultiEconomyAPI plugin) {
        super("msetmoney", "Set money of player", "/setmoney <player> <amount>");
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if (!sender.hasPermission("multieconomyapi.command.setmoney")) {
