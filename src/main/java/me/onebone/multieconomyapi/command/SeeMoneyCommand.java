...
public class SeeMoneyCommand extends Command {
    ...
    public SeeMoneyCommand(MultiEconomyAPI plugin) {
        super("mseemoney", "Show other players' money", "/seemoney <player>");
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        if (!sender.hasPermission("multieconomyapi.command.seemoney")) {
