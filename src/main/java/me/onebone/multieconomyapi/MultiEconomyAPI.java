package me.onebone.multieconomyapi;
...
import me.onebone.multieconomyapi.command.GiveMoneyCommand;
import me.onebone.multieconomyapi.command.MyMoneyCommand;
import me.onebone.multieconomyapi.command.PayCommand;
import me.onebone.multieconomyapi.command.SeeMoneyCommand;
import me.onebone.multieconomyapi.command.SetMoneyCommand;
import me.onebone.multieconomyapi.command.TakeMoneyCommand;
import me.onebone.multieconomyapi.command.TopMoneyCommand;
import me.onebone.multieconomyapi.event.account.CreateAccountEvent;
import me.onebone.multieconomyapi.event.money.AddMoneyEvent;
import me.onebone.multieconomyapi.event.money.ReduceMoneyEvent;
import me.onebone.multieconomyapi.event.money.SetMoneyEvent;
import me.onebone.multieconomyapi.json.JSONObject;
import me.onebone.multieconomyapi.provider.Provider;
import me.onebone.multieconomyapi.provider.YamlProvider;
import me.onebone.multieconomyapi.task.AutoSaveTask;

public class MultiEconomyAPI extends PluginBase implements Listener {

    private static MultiEconomyAPI instance;
    ...
    public static MultiEconomyAPI getInstance() {
        return instance;
    }
    ...
    private void registerCommands() {
        this.getServer().getCommandMap().register("mmymoney", new MyMoneyCommand(this));
        this.getServer().getCommandMap().register("mtopmoney", new TopMoneyCommand(this));
        this.getServer().getCommandMap().register("mseemoney", new SeeMoneyCommand(this));
        this.getServer().getCommandMap().register("mgivemoney", new GiveMoneyCommand(this));
        this.getServer().getCommandMap().register("mtakemoney", new TakeMoneyCommand(this));
        this.getServer().getCommandMap().register("mpay", new PayCommand(this));
        this.getServer().getCommandMap().register("msetmoney", new SetMoneyCommand(this));
    }
